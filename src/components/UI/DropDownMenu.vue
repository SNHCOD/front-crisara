...
<template>
    <div>
        <a class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-default md:p-0 cursor-pointer" link="#" @click="toggle = !toggle" >
            <slot></slot>
        </a>
        <!-- Dropdown menu -->
